...
public class User {
    ...
    private HashSet<Integer> list2 = new HashSet<>();
    private ArrayList<Short> list3 = new ArrayList<>();
    private HashSet<Long> list4 = new HashSet<>();
    ...
    private HashMap<Integer, Short  > map3 = new HashMap<>();
    private HashMap<Integer, Byte   > map4 = new HashMap<>();
    private HashMap<Integer, Float  > map5 = new HashMap<>();
    private HashMap<Integer, Double > map6 = new HashMap<>();
    private HashMap<Integer, Date   > map7 = new HashMap<>();


    private HashMap<Integer, Integer> map11 = new HashMap<>();
    private HashMap<String , String > map12 = new HashMap<>();
    private HashMap<Short  , Short  > map13 = new HashMap<>();
    private HashMap<Byte   , Byte   > map14 = new HashMap<>();
    private HashMap<Float  , Float  > map15 = new HashMap<>();
    private HashMap<Double , Double > map16 = new HashMap<>();
    private HashMap<Date   , Date   > map17 = new HashMap<>();

    private HashMap<String, Integer> map20 = new HashMap<>();
